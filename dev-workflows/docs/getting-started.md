...
This is separate from *grilling*, the relentless one-question-at-a-time interrogation technique that `idea:`, `create-vi:`, `update-vi:`, `create-ard:`, `specify:`, and `design:` all run to converge on a well-formed artifact. Grilling is **not** an external dependency — it is bundled in this plugin, at [`skills/_shared/grilling-technique.md`](../skills/_shared/grilling-technique.md).
