...
`release-notes:` skill cites this file for its own invariants (§1/§3 for the draft shape, §4 for the documentation-link rule) but never re-derives the writer's decision; the agent applies it and returns a proposed
